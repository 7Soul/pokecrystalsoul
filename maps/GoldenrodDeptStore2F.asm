...
GoldenrodDeptStore2F_MapEvents:
	...
	object_event 13,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStore2FOfficer, ACHIEV_HAS_ONE_BADGE
