...
Route32_MapEvents:
	...
	bg_event  6, 80, BGEVENT_READ, Route32UnionCaveSign
	...
	object_event  7, 80, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route32RoarTMGuyScript, -1
