...
AnimObjSplashGFX:    INCBIN "gfx/battle_anims/splash.2bpp.lz"
AnimObjWoodGFX:      INCBIN "gfx/battle_anims/wood.2bpp.lz"
AnimObjSnowGFX:      INCBIN "gfx/battle_anims/snow.2bpp.lz"
AnimObjFeatherGFX:   INCBIN "gfx/battle_anims/feather.2bpp.lz"
