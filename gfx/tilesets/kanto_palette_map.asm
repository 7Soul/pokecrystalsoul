	...
	tilepal 0, GREEN, GREEN, GREEN, ROOF, BROWN, GRAY, BROWN, BROWN
	tilepal 0, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 0, GREEN, GREEN, BROWN, BROWN, BROWN, ROOF, ROOF, ROOF
	tilepal 0, ROOF, ROOF, YELLOW, YELLOW, YELLOW, GRAY, BROWN, GRAY
	tilepal 0, BROWN, BROWN, BROWN, BROWN, WATER, ROOF, ROOF, ROOF
	tilepal 0, ROOF, ROOF, GRAY, BROWN, BROWN, GRAY, BROWN, GRAY
	tilepal 1, BROWN, BROWN, BROWN, GRAY, BROWN, ROOF, ROOF, BROWN
