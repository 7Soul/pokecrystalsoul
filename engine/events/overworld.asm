...
.cant_burn
	ld a, BANK(CantBurnScript)
	ld hl, CantBurnScript
	call CallScript
	scf
	ret
...
.CheckAble:
	...
	;call CheckBadge
	;jr c, .nohivebadge
	call CheckMapForSomethingToBurn
	jr c, .nothingtoburn
	ld a, $1
	ret
...
.DoBurn:
	ld hl, Script_BurnFromMenu
	call QueueScript
	ld a, $81
	ret

.FailBurn:
	ld hl, Text_NothingToBurn
	call MenuTextBoxBackup
	ld a, $80
	ret
...
Text_UsedBurn:
	; used CUT!
	text_jump text_usedburn
	db "@"

Text_NothingToBurn:
	; There's nothing to CUT here.
	text_jump text_nothingtoburn
	db "@"
...
Script_Burn:
	callasm GetPartyNick
	writetext Text_UsedBurn
	reloadmappart
	callasm BurnDownTreeOrGrass
	closetext
	end
...
gettext_askburn:
	text_jump text_askburn
	db "@"

CantBurnScript:
	jumptext gettext_cantburn

gettext_cantburn:
	text_jump text_cantburn
	db "@"
