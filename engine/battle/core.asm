...
; From there, an 3% chance for Item2
	call BattleRandom
	cp 20 percent ; 20% of 15% = 3% Item2
	ld a, [wBaseItem1]
	jr nc, .UpdateItem
	ld a, [wBaseItem2]
	jr .UpdateItem
...
.caught_or_defeated_roam_mon
	callfar GetRoamMonHP
	ld [hl], 0
	callfar GetRoamMonMapGroup
	ld [hl], GROUP_N_A
	callfar GetRoamMonMapNumber
	ld [hl], MAP_N_A
	callfar GetRoamMonSpecies
	ld [hl], 0
	ret
