; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_SP_ATK_SP_DEF_UP
	const EFFECT_DEF_SP_DEF_UP
	...
	const EFFECT_SELFSPATK_DOWN_HIT
	const EFFECT_SELFSPEED_DOWN_HIT
	...
	const EFFECT_FIRE_FLICK
	const EFFECT_STAMPEDE
	const EFFECT_LEAF_SHIELD
	const EFFECT_JET_STREAM
	const EFFECT_FIRE_PLAY
	const EFFECT_ACUPRESSURE
	const EFFECT_LOW_PRIORITY
	const EFFECT_SWITCH_HIT
	const EFFECT_REGEN_SLOW
