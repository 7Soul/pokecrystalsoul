...
; BattleVarPairs indexes (see home/battle.asm)
	...
	const BATTLE_VARS_TRAIT2
	const BATTLE_VARS_TRAIT_OPP2
	const BATTLE_VARS_TRAIT3
	const BATTLE_VARS_TRAIT_OPP3
...
; BattleVarLocations indexes (see home/battle.asm)
	...
	const PLAYER_STATUS
	const ENEMY_STATUS
	const PLAYER_TRAIT  ; 0c
	const ENEMY_TRAIT   ; 0d
	const PLAYER_TRAIT2 ; 0e
	const ENEMY_TRAIT2  ; 0f
	const PLAYER_TRAIT3 ; 10
	const ENEMY_TRAIT3  ; 11
...
SUBSTATUS_REGEN_STAMINA EQU 4
SUBSTATUS_REGEN_STAMINA_MASK EQU 1 << 4
SUBSTATUS_REGEN_STAMINA_TURNS EQU %1110
