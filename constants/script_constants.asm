...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_VIRIDIAN_FOREST_1
	const FRUITTREE_VIRIDIAN_FOREST_2
...
; MoveTutor writebyte arguments
	...
	const MOVETUTOR_HARMONY      ; 4
	const MOVETUTOR_SILVER_WIND  ; 5
