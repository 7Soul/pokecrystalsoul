...
; Johto Gym Leader TM gifts
	const EVENT_GOT_TM13_FEATHER_GALE
	const EVENT_GOT_TM49_UTURN
...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	const EVENT_GOT_HM01_AQUA_TAIL
	const EVENT_GOT_HM02_FLY
	const EVENT_GOT_HM03_SURF
	const EVENT_GOT_HM04_NASTY_PLOT
	const EVENT_GOT_HM05_MAGMA_STORM
...
; Johto story events
	...
	const EVENT_GOT_MON1_FROM_ELM
	const EVENT_GOT_MON2_FROM_ELM
	const EVENT_GOT_MON3_FROM_ELM
	...
	const EVENT_GOT_TM31_MUD_BOMB_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_TM12_FELL_STINGER
...
; Kanto hidden items
	...
	const EVENT_VIRIDIAN_FOREST_HIDDEN_HYPER_POTION
; ???
	const EVENT_105
	const EVENT_106
	const EVENT_107
...
; Twins
	...
	const EVENT_BEAT_TWINS_CHLOE_AND_IVY
	const EVENT_BEAT_TWINS_CHLOE_AND_IVY2
	const EVENT_BEAT_TWINS_RUBY_AND_AMBER
	const EVENT_BEAT_TWINS_RUBY_AND_AMBER2
	const EVENT_BEAT_TWINS_RAIN_AND_KAI
	const EVENT_BEAT_TWINS_RUBY_AND_KAI2
; Schoolboy
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_BUG_CATCHER_BARRY
	const EVENT_BEAT_BUG_CATCHER_PIPPA
...
; Achievements
	const ACHIEV_HAS_NEW_ACHIVEMENT
NUM_ACHIEV_START EQU const_value
	const ACHIEV_CAUGHT_MON
	const ACHIEV_CAUGHT_MON_WARNED
	const ACHIEV_CAUGHT_MON_RARE_TRAIT
	const ACHIEV_CAUGHT_MON_RARE_TRAIT_WARNED
	const ACHIEV_CAUGHT_MON_HOLDING_ITEM
	const ACHIEV_CAUGHT_MON_HOLDING_ITEM_WARNED
	const ACHIEV_CAUGHT_MON_EGG_MOVE
	const ACHIEV_CAUGHT_MON_EGG_MOVE_WARNED
	const ACHIEV_MAX_POKEDEX_DATA
	const ACHIEV_MAX_POKEDEX_DATA_WARNED
	const ACHIEV_POKEMON_SEEN
	const ACHIEV_POKEMON_SEEN_WARNED
	const ACHIEV_POKEMON_CAUGHT
	const ACHIEV_POKEMON_CAUGHT_WARNED
	const ACHIEV_POKEMON_LEVEL_15
	const ACHIEV_POKEMON_LEVEL_15_WARNED
	const ACHIEV_POKEMON_LEVEL_30
	const ACHIEV_POKEMON_LEVEL_30_WARNED
	const ACHIEV_POKEMON_LEVEL_50
	const ACHIEV_POKEMON_LEVEL_50_WARNED
	const ACHIEV_POKEMON_LEVEL_70
	const ACHIEV_POKEMON_LEVEL_70_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_BIRD
	const ACHIEV_CAUGHT_LEGENDARY_BIRD_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_BEAST
	const ACHIEV_CAUGHT_LEGENDARY_BEAST_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_HO_OH
	const ACHIEV_CAUGHT_LEGENDARY_HO_OH_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_LUGIA
	const ACHIEV_CAUGHT_LEGENDARY_LUGIA_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_MEW
	const ACHIEV_CAUGHT_LEGENDARY_MEW_WARNED
	const ACHIEV_CAUGHT_LEGENDARY_CELEBI
	const ACHIEV_CAUGHT_LEGENDARY_CELEBI_WARNED
	const ACHIEV_CAUGHT_FOUR_LEGENDARY
	const ACHIEV_CAUGHT_FOUR_LEGENDARY_WARNED
	const ACHIEV_DEFEATED_RED
	const ACHIEV_DEFEATED_RED_WARNED
	const ACHIEV_HAS_ONE_BADGE
	const ACHIEV_HAS_ONE_BADGE_WARNED
	const ACHIEV_HAS_FOUR_BADGES
	const ACHIEV_HAS_FOUR_BADGES_WARNED
	const ACHIEV_HAS_EIGHT_BADGES
	const ACHIEV_HAS_EIGHT_BADGES_WARNED
	const ACHIEV_HAS_TWELVE_BADGES
	const ACHIEV_HAS_TWELVE_BADGES_WARNED
	const ACHIEV_HAS_SIXTEEN_BADGES
	const ACHIEV_HAS_SIXTEEN_BADGES_WARNED
	const ACHIEV_BEAT_ELITE_FOUR_1
	const ACHIEV_BEAT_ELITE_FOUR_1_WARNED
	const ACHIEV_BEAT_ELITE_FOUR_2
	const ACHIEV_BEAT_ELITE_FOUR_2_WARNED
	const ACHIEV_DEFEAT_ROCKET_PROTON
	const ACHIEV_DEFEAT_ROCKET_PROTON_WARNED
	const ACHIEV_DEFEAT_ROCKET_ARIANA
	const ACHIEV_DEFEAT_ROCKET_ARIANA_WARNED
	const ACHIEV_DEFEAT_ROCKET_PRETEL
	const ACHIEV_DEFEAT_ROCKET_PRETEL_WARNED
	const ACHIEV_DEFEAT_ROCKET_ARCHER
	const ACHIEV_DEFEAT_ROCKET_ARCHER_WARNED
	const ACHIEV_DEFEAT_ROCKET_KODIAK
	const ACHIEV_DEFEAT_ROCKET_KODIAK_WARNED
	const ACHIEV_DEFEAT_ROCKET_SABER
	const ACHIEV_DEFEAT_ROCKET_SABER_WARNED
	const ACHIEV_DEFEAT_ROCKET_GIOVANNI
	const ACHIEV_DEFEAT_ROCKET_GIOVANNI_WARNED
	
NUM_ACHIEVEMENTS EQU const_value - NUM_ACHIEV_START
	; const EVENT_5F9
	; const EVENT_5FA
	; const EVENT_5FB
	; const EVENT_5FC
...
; Johto itemballs
	const EVENT_MON1_POKEBALL_IN_ELMS_LAB
	const EVENT_MON2_POKEBALL_IN_ELMS_LAB
	const EVENT_MON3_POKEBALL_IN_ELMS_LAB
	const EVENT_VIOLET_CITY_PP_UP
	const EVENT_VIOLET_CITY_RARE_CANDY
	const EVENT_LAKE_OF_RAGE_ELIXER
	const EVENT_LAKE_OF_RAGE_TM_BRICK_BREAK
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_TM_PRISM_LIGHT
	...
	const EVENT_CHERRYGROVE_POTION
; Johto people
	...
	const EVENT_CONTESTANT1_1
	const EVENT_CONTESTANT1_2
	const EVENT_CONTESTANT1_3
	const EVENT_CONTESTANT2_1
	...
	const EVENT_ROUTE29_MOVE_TUTOR
; Kanto people
...
; New to Crystal
	...
	const EVENT_GOT_MON4_FROM_ELM
	const EVENT_GOT_MON5_FROM_ELM
	const EVENT_GOT_MON6_FROM_ELM
	const EVENT_MON4_POKEBALL_IN_ELMS_LAB
	const EVENT_MON5_POKEBALL_IN_ELMS_LAB
	const EVENT_MON6_POKEBALL_IN_ELMS_LAB
	const EVENT_BEAT_FISHER_TERRY
	const EVENT_BEAT_CONTESTANT1_1
	const EVENT_BEAT_CONTESTANT1_2
	const EVENT_BEAT_CONTESTANT1_3
	const EVENT_BEAT_CONTESTANT2_1
