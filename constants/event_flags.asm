...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM23_FROZEN_TAIL
...
; ???
	const EVENT_HAS_NEW_ACHIVEMENT
NUM_ACHIEV_START EQU const_value
	const EVENT_HAS_ONE_BADGE
	const EVENT_HAS_TWO_BADGES
	const EVENT_HAS_THREE_BADGES
	const EVENT_HAS_FOUR_BADGES
	const EVENT_HAS_FIVE_BADGES
	const EVENT_HAS_SIX_BADGES
	const EVENT_HAS_SEVEN_BADGES
	const EVENT_HAS_EIGHT_BADGES
	const EVENT_HAS_NINE_BADGES
	const EVENT_HAS_TEN_BADGES
	const EVENT_HAS_ELEVEN_BADGES
	const EVENT_HAS_TWELVE_BADGES
	const EVENT_HAS_THIRTEEN_BADGES
	const EVENT_HAS_FOURTEEN_BADGES
	const EVENT_HAS_FIFHTEEN_BADGES
	const EVENT_HAS_SIXTEEN_BADGES
	const EVENT_CAUGHT_MON_RARE_TRAIT
	const EVENT_CAUGHT_MON_RARE_TRAIT_WARNED
	const EVENT_CAUGHT_MON_EGG_MOVE
	const EVENT_CAUGHT_MON_EGG_MOVE_WARNED
...
; Johto itemballs
	...
	const EVENT_GOT_TM47_ICICLE_WING
...
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_1F_TM_ICICLE_WING
