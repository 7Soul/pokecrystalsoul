; battle_anim_struct members (see macros/wram.asm)
	...
	const BATTLEANIMSTRUCT_11 ; Unused
	const BATTLEANIMSTRUCT_12 ; Unused
	const BATTLEANIMSTRUCT_13 ; Unused
	const BATTLEANIMSTRUCT_14 ; Unused
	const BATTLEANIMSTRUCT_15 ; Unused
	const BATTLEANIMSTRUCT_16 ; Unused
	const BATTLEANIMSTRUCT_17 ; Unused
...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_PALM
	const ANIM_OBJ_FANG
	const ANIM_OBJ_PUNCH_SIDE_TO_SIDE
	...
	const ANIM_OBJ_SHOCKS_AROUND_CENTER
	...
	const ANIM_OBJ_METRONOME
	const ANIM_OBJ_METRONOME_SPARKS
	...
	const ANIM_OBJ_SAND_SIMPLE_FLIP
	...
	const ANIM_OBJ_ZAP_CANNON2
	const ANIM_OBJ_SHOCKS_AROUND_CENTER2
...
; BattleBGEffects indexes (see engine/battle_anims/bg_effects.asm)
	...
	const ANIM_BG_CYCLE_OBPALS_GRAY_YELLOW
	const ANIM_BG_CYCLE_OBPALS_GRAY_YELLOW_STRONG
	const ANIM_BG_BLACK_CYCLE_HUES
	...
	const ANIM_BG_USER_FADE_TO_LIGHT1
	const ANIM_BG_USER_FADE_TO_LIGHT2
	const ANIM_BG_USER_CYCLE_LIGHT
	const ANIM_BG_USER_CYCLE_DARK
	const ANIM_BG_USER_CYCLE_DARK_AND_LIGHT
	const ANIM_BG_USER_FLASH_BLACK_COLOR_WHITE
	const ANIM_BG_OPP_CYCLE_DARK_USER_CYCLE_WHITE
	const ANIM_BG_OPP_FADE_TO_WHITE
	const ANIM_BG_OPP_FLASH_THEN_RECOLOR
	const ANIM_BG_SHAKE_SCREEN_H
	const ANIM_BG_SHAKE_SCREEN_V
	const ANIM_BG_WITHDRAW
	const ANIM_BG_BOUNCE_DOWN
	const ANIM_BG_DIG
	const ANIM_BG_TACKLE
	const ANIM_BG_BODY_SLAM
	const ANIM_BG_TAIL_WHIP
	const ANIM_BG_ROAR
