...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_XSCISSOR1
	const ANIM_OBJ_XSCISSOR2
	...
	const ANIM_OBJ_SPARKS_CIRCLE_BIG2
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_DIGB
	const BATTLEANIMFUNC_GROWTH_SWORDS_DANCEb
	const BATTLEANIMFUNC_STRENGTH_SEISMIC_TOSSb
