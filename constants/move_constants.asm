...
; wNumHits uses offsets from ANIM_MISS
	...
	const ICE_SHARD       ; 0b
	const ACCELEROCK_MOVE ; 0c
	const AQUA_JET        ; 0d
	const BULLET_PUNCH    ; 0e
	const NIGHT_SLASH     ; 0f
	const LEAF_BLADE      ; 10
	const SEED_BOMB       ; 11
	const AERIAL_ACE      ; 13
	const FEATHERDANCE    ; 14
	const FISSURE         ; 15
	const SHEER_COLD      ; 16
	const GUILLOTINE      ; 17
	const WITHDRAW        ; 18
	const IRON_DEFENSE    ; 19
	const BONEMERANG      ; 1a
	const ENERGY_BALL     ; 1b
	const FLAIL           ; 1c
	const MUD_SHOT        ; 1d
	const MEGA_SPLASH     ; 1e
	const SAND_DIVE       ; 1f
	const HURRICANE       ; 20
	const RAZOR_SHELL     ; 21
	const SPIRAL_KICK     ; 22
	const POWER_WHIP      ; 23
	const ROCK_POLISH     ; 24
	const SHOCK_STING     ; 25
	const PSYSHOCK        ; 26
	const ROCK_TUMBLE     ; 27
	const BRUTAL_VINE     ; 28
	const DOUBLE_HIT      ; 29
	const WATERFALL       ; 2a
	const IRON_HEAD       ; 2b
