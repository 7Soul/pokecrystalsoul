...
; wNumHits uses offsets from ANIM_MISS
	...
	const ICE_SHARD       ; 0a
	const ACCELEROCK_MOVE ; 0b
	const AQUA_JET        ; 0c
	const NIGHT_SLASH     ; 0d
	const LEAF_BLADE      ; 0e
	const SEED_BOMB       ; 0f
	const AERIAL_ACE      ; 10
	const FEATHERDANCE    ; 11
	const FISSURE         ; 13
	const SHEER_COLD      ; 14
	const GUILLOTINE      ; 15
	const WITHDRAW        ; 16
	const IRON_DEFENSE    ; 17
	const BONEMERANG      ; 18
	const ENERGY_BALL     ; 19
	const FLAIL           ; 1a
	const MUD_SHOT        ; 1b
	const MEGA_SPLASH     ; 1c
	const SAND_DIVE       ; 1d
	const HURRICANE       ; 1e
	const RAZOR_SHELL     ; 1f
	const SPIRAL_KICK     ; 20
	const POWER_WHIP      ; 21
	const ROCK_POLISH     ; 22
	const SHOCK_STING     ; 23
	const ROCK_TUMBLE     ; 24
	const BRUTAL_VINE     ; 25
	const DOUBLE_HIT      ; 26
	const WATERFALL       ; 27
