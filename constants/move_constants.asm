...
; wNumHits uses offsets from ANIM_MISS
	...
	const ICE_SHARD       ; 0d
	const ACCELEROCK_MOVE ; 0e
	const AQUA_JET        ; 0f
	const BULLET_PUNCH    ; 10
	const NIGHT_SLASH     ; 11
	const LEAF_BLADE      ; 13
	const SEED_BOMB       ; 14
	const AERIAL_ACE      ; 15
	const FEATHERDANCE    ; 16
	const FISSURE         ; 17
	const SHEER_COLD      ; 18
	const GUILLOTINE      ; 19
	const WITHDRAW        ; 1a
	const IRON_DEFENSE    ; 1b
	const BONEMERANG      ; 1c
	const ENERGY_BALL     ; 1d
	const FLAIL           ; 1e
	const THUNDER_BLOW    ; 1f
	const MUD_SHOT        ; 20
	const MEGA_SPLASH     ; 21
	const SAND_DIVE       ; 22
	const FLAME_STOMP     ; 23
	const HURRICANE       ; 24
	const RAZOR_SHELL     ; 25
	const SPIRAL_KICK     ; 26
	const POWER_WHIP      ; 27
	const ROCK_POLISH     ; 28
	const SHOCK_STING     ; 29
	const PSYSHOCK        ; 2a
	const ROCK_TUMBLE     ; 2b
	const BRUTAL_VINE     ; 2c
	const DOUBLE_HIT      ; 2d
	const WATERFALL       ; 2e
	const IRON_HEAD       ; 2f
	const EXTRASENSORY    ; 30
	const FIRE_FANG       ; 31
	const ICE_FANG        ; 32
