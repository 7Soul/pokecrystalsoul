...
; wNumHits uses offsets from ANIM_MISS
	...
	const SEED_BOMB       ; 10
	const AERIAL_ACE      ; 11
	const FEATHERDANCE    ; 13
	const FISSURE         ; 14
	const SHEER_COLD      ; 15
	const GUILLOTINE      ; 16
	const WITHDRAW        ; 17
	const IRON_DEFENSE    ; 18
	const BONEMERANG      ; 19
	const ENERGY_BALL     ; 1a
	const FLAIL           ; 1b
	const MUD_SHOT        ; 1c
	const MEGA_SPLASH     ; 1d
	const SAND_DIVE       ; 1e
	const HURRICANE       ; 1f
	const RAZOR_SHELL     ; 20
	const SPIRAL_KICK     ; 21
	const POWER_WHIP      ; 22
	const ROCK_POLISH     ; 23
	const SHOCK_STING     ; 24
	const ROCK_TUMBLE     ; 25
	const BRUTAL_VINE     ; 26
	const DOUBLE_HIT      ; 27
	const WATERFALL       ; 28
