...
; wNumHits uses offsets from ANIM_MISS
	...
	const POWER_WHIP      ; 28
	const TAIL_SMACK      ; 29
	const ROCK_POLISH     ; 2a
	const SHOCK_STING     ; 2b
	const PSYSHOCK        ; 2c
	const ROCK_TUMBLE     ; 2d
	const BRUTAL_VINE     ; 2e
	const DOUBLE_HIT      ; 2f
	const WATERFALL       ; 30
	const IRON_HEAD       ; 31
	const EXTRASENSORY    ; 32
	const FIRE_FANG       ; 33
	const ICE_FANG        ; 34
	const THUNDER_FANG    ; 35
	const CALM_MIND       ; 36
	const COSMIC_POWER    ; 37
	const ROOST           ; 38
	const AVALANCHE       ; 39
	const REVENGE         ; 3a
	const GUARD_CLAW      ; 3b
	const BRINE           ; 3c
	const POISON_FANG     ; 3d
	const WATER_PULSE     ; 3e
	const CLEAR_SMOG      ; 3f
	const VOLT_SWITCH     ; 40
	const AQUA_RING       ; 41
	const INGRAIN         ; 42
	const CYCLE_FOE       ; 43
	const AROMATHERAPY    ; 44
