...
; wNumHits uses offsets from ANIM_MISS
	...
	const ICE_SHARD       ; 0c
	const ACCELEROCK_MOVE ; 0d
	const AQUA_JET        ; 0e
	const BULLET_PUNCH    ; 0f
	const NIGHT_SLASH     ; 10
	const LEAF_BLADE      ; 11
	const SEED_BOMB       ; 13
	const AERIAL_ACE      ; 14
	const FEATHERDANCE    ; 15
	const FISSURE         ; 16
	const SHEER_COLD      ; 17
	const GUILLOTINE      ; 18
	const WITHDRAW        ; 19
	const IRON_DEFENSE    ; 1a
	const BONEMERANG      ; 1b
	...
	const SAND_DIVE       ; 20
	const HURRICANE       ; 21
	const RAZOR_SHELL     ; 22
	const SPIRAL_KICK     ; 23
	const POWER_WHIP      ; 24
	const ROCK_POLISH     ; 25
	const SHOCK_STING     ; 26
	const PSYSHOCK        ; 27
	const ROCK_TUMBLE     ; 28
	const BRUTAL_VINE     ; 29
	const DOUBLE_HIT      ; 2a
	const WATERFALL       ; 2b
	const IRON_HEAD       ; 2c
