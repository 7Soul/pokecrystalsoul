...
; wNumHits uses offsets from ANIM_MISS
	...
	const ROCK_BLAST      ; 02
	const GATHER_SAND     ; 03
	const TIDE_CLASH      ; 04
	const FLUTTER_CLAP    ; 05
	const STONE_EDGE      ; 06
	const BRAVE_BIRD      ; 07
	const WOOD_HAMMER     ; 08
	const ICE_SHARD       ; 09
	const ACCELEROCK_MOVE ; 0a
	const AQUA_JET        ; 0b
	const NIGHT_SLASH     ; 0c
	const LEAF_BLADE      ; 0d
	const SEED_BOMB       ; 0e
	const AERIAL_ACE      ; 0f
	const FEATHERDANCE    ; 10
	const FISSURE         ; 11
	const SHEER_COLD      ; 13
	const GUILLOTINE      ; 14
	const WITHDRAW        ; 15
	const IRON_DEFENSE    ; 16
	const BONEMERANG      ; 17
	const ENERGY_BALL     ; 18
	const FLAIL           ; 19
	const MUD_SHOT        ; 1a
	const MEGA_SPLASH     ; 1b
	const SAND_DIVE       ; 1c
	const HURRICANE       ; 1d
	const RAZOR_SHELL     ; 1e
	const SPIRAL_KICK     ; 1f
	const POWER_WHIP      ; 20
	const ROCK_POLISH     ; 21
	const SHOCK_STING     ; 22
	const ROCK_TUMBLE     ; 23
	const BRUTAL_VINE     ; 24
	const DOUBLE_HIT      ; 25
	const WATERFALL       ; 26
