...
FalknerGroup:
	...
	db $07, 12, 1, MURKROW, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FEATHERGALE
	db $05, 11, 1, HOOTHOOT, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 14, 0, SKARMORY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, WILD_STORM
	db $26, 12, 1, HOPPIP, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 12, 1, TOGEPI, 0, 3, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 16, 1, TOGEPI, 0, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 14, 1, HOOTHOOT, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 12, 1, AERODACTYL, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $9F, 12, 0, ARTICUNO, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FLY
	db $02, 15, 1, PIDGEOTTO, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FEATHERGALE
	db $25, 15, 1, PIDGEOTTO, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FEATHERGALE
	db $5F, 16, 1, PIDGEOTTO, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db $04, 12, 0, PINSIR, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $02, 13, 0, EEVEE, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $2F, 10, 2, EEVEE, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FELL_STINGER
	db $37, 12, 0, SHUCKLE, 0, 5, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 15, 0, HERACROSS, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 16, 0, HERACROSS, 0, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $EF, 15, 0, CELEBI, $80, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $8E, 16, 1, VENONAT, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 13, 0, PIKACHU, $40, 0, BATTERY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $79, 12, 1, PINECO, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $14, 14, 0, SCYTHER, $40, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, FURY_CUTTER
	db $4F, 15, 0, SCIZOR, $40, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, FURY_CUTTER
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "Whitney@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	db $03, 9, 0, DITTO, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $01, 11, 0, SMOOCHUM, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $04, 10, 0, CLEFAIRY, $40, 1, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, ATTRACT
	db $4F, 6, 1, CLEFAIRY, $40, 1, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, ATTRACT
	db $3F, 5, 1, TEDDIURSA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $37, 6, 1, SQUIRTLE, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 10, 1, SQUIRTLE, $40, 0, NO_ITEM, HYPER_BEAM, SKULL_BASH, SWAGGER, PROTECT
	db $6F, 6, 1, MEOWTH, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $8F, 10, 1, CHANSEY, $40, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, ROLLOUT
	db $14, 9, 0, MILTANK, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, ROLLOUT, ATTRACT
	db $47, 10, 1, MILTANK, $40, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, ROLLOUT, ATTRACT
	db $7F, 14, 1, MILTANK, $40, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, ROLLOUT, ATTRACT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "Morty@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES | TRAINERTYPE_ITEM
	db $04, 6, 0, MISDREAVUS, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $12, 6, 0, UNOWN, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $4F, 10, 1, MISDREAVUS, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $2F, 6, 1, SNEASEL, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $1F, 8, 1, BULBASAUR, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $04, 10, 1, GASTLY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $15, 6, 1, PARAS, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 8, 1, PARAS, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 10, 1, GASTLY, 0, 0, NO_ITEM, HYPNOSIS, DREAM_EATER, NIGHT_SHADE, CURSE
	db $7F, 10, 1, HOUNDOUR, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 14, 1, GASTLY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "Pryce@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	db $04, 9, 0, SWINUB, 0, 1, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, POWDER_SNOW
	db $47, 7, 1, SWINUB, 0, 4, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, ICY_WIND
	db $7F, 13, 1, SWINUB, 0, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $23, 11, 0, SEEL, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $37, 13, 1, SEEL, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 13, 1, SEEL, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $46, 6, 0, SHELLDER, 0, 4, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, ICY_WIND
	db $6F, 4, 0, LAPRAS, $40, 8, MINT_BERRY, ICE_BEAM, REST, SURF, HYDRO_PUMP
	db $5F, 4, 1, OMANYTE, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $25, 6, 1, OMANYTE, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 14, 1, SEEL, 0, 9, NEVERMELTICE, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $9F, 16, 0, SUICUNE, $80, 9, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "Jasmine@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES | TRAINERTYPE_ITEM
	db $03, 10, 1, MAGNEMITE, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, PRISM_LIGHT,THUNDERSHOCK
	db $37, 12, 1, MAGNEMITE, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, PRISM_LIGHT
	db $7F, 10, 0, MAGNETON, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, PRISM_LIGHT,ZAP_CANNON
	db $15, 8, 1, ONIX, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, SANDSTORM
	db $13, 11, 1, CUBONE, $40, 0, NO_ITEM, GROWL,MAKESHIFT,DIG,TACKLE
	db $39, 11, 1, SKARMORY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 10, 1, STEELIX, $40, 0, NO_ITEM, SANDSTORM,DIG,ICY_WIND,CRUNCH
	db $46, 6, 0, FLAAFFY, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, PRISM_LIGHT
	db $6F, 14, 0, AMPHAROS, $40, 9, BATTERY, NO_MOVE, NO_MOVE, NO_MOVE, PRISM_LIGHT
	db $6F, 15, 0, ONIX, $40, 0, NO_ITEM, STAMPEDE, SANDSTORM, SLAM, EARTHQUAKE
	db $8F, 8, 0, SCIZOR, 0, 9, BATTERY, NO_MOVE, NO_MOVE, NO_MOVE, HIDDEN_POWER
	db $9F, 16, 0, MAGNETON, $80, 9, BATTERY, PRISM_LIGHT,ZAP_CANNON,DOUBLE_TEAM,SWIFT
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "Chuck@", TRAINERTYPE_MOVES | TRAINERTYPE_DVS | TRAINERTYPE_ITEM
	db $0F, 10, 0, MANKEY, $40, 7, GOLD_BERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $03, 6, 1, POLIWAG, 0, 2, BERRY, NO_MOVE, BUBBLE, HYPNOSIS, WAKEUP_SLAP
	db $0F, 8, 0, HITMONLEE, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $13, 6, 1, PHANPY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $37, 10, 1, POLIWAG, 0, 2, BERRY, HYPNOSIS, SURF, WAKEUP_SLAP, BODY_SLAM
	db $3F, 8, 0, HITMONCHAN, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $4F, 6, 1, PHANPY, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 8, 1, TOTODILE, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 13, 1, POLIWAG, 0, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "Clair@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	db $04, 3, 1, HORSEA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $46, 3, 1, SEADRA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 3, 1, KINGDRA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $06, 3, 1, DRATINI, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 5, 1, MAGIKARP, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 4, 1, SLOWKING, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 5, 0, AERODACTYL, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 4, 1, SUICUNE, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 8, 1, DRAGONITE, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
MistyGroup:
	...
	db $0F, 8, 1, PSYDUCK, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $01, 13, 0, STARYU, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $14, 10, 0, STARYU, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $46, 13, 0, GOLDEEN, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $8F, 3, 1, SEEL, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $3F, 8, 0, VAPOREON, 0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $5F, 10, 0, CORSOLA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 12, 1, GOLDEEN, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $15, 14, 1, STARMIE, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $59, 17, 1, STARMIE, $80, 5, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
	db $9F, 20, 1, STARMIE, $80, 9, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, JET_STREAM
...
YoungsterGroup:
	...
	db $04, 5, 0, RATTATA, $A0, 1, CUTE_RIBBON
	db $47, 8, 0, RATTATA, $A0, 1, CUTE_RIBBON
	db $7A, 15, 0, RATTATA, $A0, 1, CUTE_RIBBON
	db $AF, 26, 0, RATTATA, $A0, 1, CUTE_RIBBON
	db -1 ; end
...
CooltrainerFGroup:
	...
	db $06, 9, 0, EEVEE, $40, 4, CUTE_RIBBON
	db $6F, 11, 0, EEVEE, $40, 4, CUTE_RIBBON
	db $1F, 4, 0, JOLTEON, $40, 0, NO_ITEM
	db $1F, 4, 0, FLAREON, $40, 0, NO_ITEM
	db $1F, 4, 0, VAPOREON, $40, 0, NO_ITEM
	db -1 ; end
...
PokemaniacGroup:
	...
	db $02, 10, 0, GLIGAR, NO_MOVE, NO_MOVE, NO_MOVE, SANDSTORM
	db $2F, 12, 0, GLIGAR, NO_MOVE, NO_MOVE, SANDSTORM, SWAGGER
	db -1 ; end
...
TeacherGroup:
	...
	db $04, 5, 0, SMEARGLE, $0, PIN_MISSILE, THUNDER_WAVE, THUNDERSHOCK, NO_MOVE
	db $48, 6, 0, SMEARGLE, $0, AGILITY, NASTY_PLOT, SILVER_WIND, THUNDERBOLT
	db $8F, 7, 0, SMEARGLE, $0, AGILITY, NASTY_PLOT, BUG_BUZZ, THUNDERBOLT
	db -1 ; end

SabrinaGroup:
	; BIRD_KEEPER (1)
	db "Sabrina@", TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db $02, 10, 1, ABRA, $40, 1, MINT_BERRY, NO_MOVE, NO_MOVE, FIRE_FLICK,REST
	db $2F, 10, 0, KADABRA, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, PSYWAVE
	db $0F, 14, 1, ESPEON, $0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, PSYWAVE
	db $2F, 10, 1, JYNX, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, PSYWAVE
	db $0F, 3, 0, MR__MIME, $0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 3, 0, STARMIE, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 3, 0, GIRAFARIG, $0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 3, 0, PSYDUCK, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $8F, 16, 0, PORYGON, $80, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $9F, 14, 0, ALAKAZAM, $40, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $15, 8, 1, DROWZEE, $0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
FisherGroup:
	...
	db $0F, 5, 1, GOLDEEN, $40
	db $1F, 8, 1, SLOWPOKE, $0
	db $2F, 8, 0, GOLDEEN, $40
	db -1 ; end

	; FISHER (2)
	db "Ralph@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db $0F, 6, 1, MAGIKARP, 0, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $19, 10, 0, DITTO, $80, CURSE,HIDDEN_POWER,TRANSFORM,NO_MOVE
	db $9F, 13, 0, DITTO, $80, CURSE,HIDDEN_POWER,TRANSFORM,NO_MOVE
	db -1 ; end
...
HikerGroup:
	...
	db $0F, 3, 0, 0, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
SageGroup:
	...
	db $04, 7, 1, BELLSPROUT
	db $4F, 8, 1, BELLSPROUT
	db $05, 7, 1, DRATINI
	db $05, 7, 1, DRATINI
	db $5F, 8, 0, DRAGONAIR
	db $5F, 8, 0, DRAGONAIR
...
OfficerGroup:
	...
	db $1F, 5, 0, MACHOP
	db $18, 9, 0, FARFETCH_D
	db $8F, 13, 0, FARFETCH_D
	db -1 ; end
...
VideoGameBoyGroup:
	...
	db $06, 5, 1, CHARMANDER, "Sch@       ", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $06, 5, 1, GEODUDE, "TurntSNACO@", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 10, 1, GRAVELER, "TurntSNACO@", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 5, 0, RATTATA, "Knurttt@   ", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 5, 1, DIGLETT, "Buttnuttz!@", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $0F, 5, 1, PIKACHU, "SPLAART!!!@", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 10, 1, CHARMANDER, "Sch@       ", WING_ATTACK, CRUNCH, FIRE_SPIN, SCARY_FACE
	db $05, 5, 1, WEEDLE, "Bundt,@    ", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $57, 12, 1, WEEDLE, "Bundt,@    ", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 30, 1, WEEDLE, "Bundt,@    ", NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
