...
FalknerGroup:
	...
	db  11, HOOTHOOT,  MUD_SLAP, GROWL, FORESIGHT, PECK
	db  10, MURKROW,   PECK, MUD_SLAP, NO_MOVE, NO_MOVE	
	db  12, JUMPLUFF,  SPLASH, MUD_SLAP, TAIL_WHIP, SYNTHESIS
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    SWIFT, DETECT, ICICLE_WING, FLY
	db -1 ; end
...
BlackbeltGroup:
	...
	db 36, HITMONLEE,  DOUBLE_TEAM, JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end
