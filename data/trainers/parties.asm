...
FalknerGroup:
	...
	db  12, JUMPLUFF,  SPLASH, MUD_BOMB, TAIL_WHIP, SYNTHESIS
	db -1 ; end
	
BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 14, PINSIR,     TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, PIKACHU,    POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 18, PINSIR,     QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db 16, HERACROSS,  QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db 18, JOLTEON,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, FROZEN_TAIL
	db -1 ; end
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, TWISTER
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, TWISTER
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, TWISTER
	db 40, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, TWISTER
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONLEE,  SWAGGER, DOUBLE_KICK, JUMP_KICK, FORESIGHT
...
ChampionGroup:
	...
	db 50, DRAGONITE,  FIRE_BLAST, SAFEGUARD, THRASH, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db 44, ONIX,       WRAP, ROCK_SLIDE, ROCK_TOMB, SANDSTORM
...
BirdKeeperGroup:
	...
	db 38, PIDGEOT,    SWIFT, PROTECT, ICICLE_WING, FLY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 37, DRAGONAIR,  WRAP, SURF, X_SCISSOR, SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 38, STARMIE,    NO_ITEM,      DOUBLE_TEAM, PSYCHIC_M, TWISTER, CONFUSE_RAY
	db 40, NIDOQUEEN,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
	db 38, STARMIE,    NO_ITEM,      BLIZZARD, PSYCHIC_M, TWISTER, RECOVER
	db -1 ; end
	...
	db 33, HORSEA,     SMOKESCREEN, LEER, WHIRLPOOL, TWISTER
	db 35, SEADRA,     SWIFT, LEER, TWISTER, TWISTER
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, LICKITUNG,  LICK, SUPERSONIC, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, EGG_BOMB, RECOVER
	db -1 ; end
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, TWISTER, REVERSAL, FURY_ATTACK
	db 34, SEAKING,    SUPERSONIC, TWISTER, REVERSAL, FURY_ATTACK
	...
	db 39, SEAKING,    ENDURE, REVERSAL, FURY_ATTACK, TWISTER
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, TWISTER, FURY_ATTACK
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, TWISTER, FURY_ATTACK
	...
	db  10, DRATINI,	WRAP, LEER, THUNDER_WAVE, WATER_GUN
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     X_SCISSOR, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 38, POLIWRATH,  SURF, SLAM, ICE_PUNCH, SUBMISSION
	db -1 ; end
...
SuperNerdGroup:
	...
	db 39, SEADRA,     SMOKESCREEN, TWISTER, SURF, TWISTER
	db -1 ; end

	; SUPER_NERD (14)
	db "MARKUS@", TRAINERTYPE_MOVES
	db 19, SLOWPOKE,   CURSE, WATER_GUN, GROWL, SLAM
	db -1 ; end
...
HikerGroup:
	...
	db 35, DUGTRIO,    MAGNITUDE, DIG, MUD_BOMB, SLASH
	db 38, STEELIX,    DIG, FROZEN_TAIL, SANDSTORM, SLAM
	db -1 ; end
...
BlackbeltGroup:
	...
	db 33, STEELIX,    EARTHQUAKE, ROCK_THROW, FROZEN_TAIL, SANDSTORM
	db 36, HITMONLEE,  DOUBLE_TEAM, JUMP_KICK, MUD_BOMB, SWIFT
	db -1 ; end
...
PicnickerGroup:
	...
	db 21, PONYTA, CARAPACE, SURF, LEAF_SHIELD, NO_MOVE, NO_MOVE
	db 21, PONYTA, CARAPACE, SURF, LEAF_SHIELD, NO_MOVE, NO_MOVE
	db 21, QUILAVA, NO_ITEM, SURF, EMBER, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	db 34, RAICHU,     SWIFT, MUD_BOMB, QUICK_ATTACK, THUNDERBOLT
	db 36, PONYTA,     DOUBLE_TEAM, STOMP, FIRE_SPIN, SUNNY_DAY
	db -1 ; end
	...
	db 32, NIDOKING,   EARTHQUAKE, DOUBLE_KICK, POISON_STING, FROZEN_TAIL
	...
	db 38, VENUSAUR,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_BOMB
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, VILEPLUME,  ABSORB, SLEEP_POWDER, ACID, NO_MOVE
	...
	db 23, GLOOM,      ABSORB, SLEEP_POWDER, ACID, NO_MOVE
...
RedGroup:
	...
	db 73, ESPEON,     MUD_BOMB, REFLECT, SWIFT, PSYCHIC_M
...
GruntFGroup:
	...
	db 18, GLOOM,      ABSORB, STUN_SPORE, SLEEP_POWDER, NO_MOVE
	db -1 ; end
