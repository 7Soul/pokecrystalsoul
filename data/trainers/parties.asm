...
FalknerGroup:
	...
	db $8F, 12, 0, ARTICUNO, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FLY
	db $02, 15, 1, PIDGEOTTO, $A0, $54, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FEATHERGALE
	db $25, 15, 1, PIDGEOTTO, $A0, $54, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FEATHERGALE
	db $5F, 16, 1, PIDGEOTTO, $A3, $54, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db $2F, 10, 2, EEVEE, $FA, $FF, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, FELL_STINGER
	db $37, 12, 0, SHUCKLE, $FA, $FF, 5, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 15, 0, HERACROSS, $FA, $FF, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 16, 0, HERACROSS, $DF, $AF, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	...
	db $79, 12, 1, PINECO, $FA,$FF, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $14, 14, 0, SCYTHER, $E7, $F2, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, FURY_CUTTER
	db $4F, 15, 0, SCIZOR, $E7, $F2, 7, SILVERPOWDER, NO_MOVE, NO_MOVE, NO_MOVE, FURY_CUTTER
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "Whitney@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	db $03, 6, 0, DITTO, $E7,$F2, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $01, 6, 0, MAGBY, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $04, 10, 0, CLEFAIRY, $A7,$A2, 1, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $4F, 6, 1, CLEFAIRY, $AA,$56, 1, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	...
	db $8F, 6, 1, CHANSEY, $AA,$56, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, ROLLOUT
	db $14, 9, 0, MILTANK, $A7,$A2, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, ROLLOUT
	db $47, 10, 1, MILTANK, $AA,$56, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, ROLLOUT
	db $7F, 14, 1, MILTANK, $AA,$56, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, ROLLOUT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "Morty@", TRAINERTYPE_DVS
	db $04, 6, 0, MISDREAVUS, $8F,$5F
	db $12, 6, 0, UNOWN, $7F,$22
	db $4F, 10, 1, MISDREAVUS, $8F,$5F
	db $2F, 6, 1, SNEASEL, $FA,$FF
	db $1F, 8, 1, BULBASAUR, $7F,$22
	db $04, 10, 1, GASTLY, $E7,$F2
	db $15, 6, 1, PARAS, $FA,$FF
	db $5F, 8, 1, PARAS, $AF,$BF
	db $47, 10, 1, GASTLY, $DA,$56
	db $7F, 10, 1, HOUNDOUR, $66, $66
	db $7F, 14, 1, GASTLY, $AA,$AA
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "Pryce@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM | TRAINERTYPE_MOVES
	db $04, 9, 0, SWINUB, $A5,$F0, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, POWDER_SNOW
	db $04, 6, 0, SEEL, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, ICY_WIND
	db $04, 6, 1, SHELLDER, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $25, 6, 1, OMANYTE, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 4, 0, SEEL, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $4F, 8, 1, SEEL, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $47, 7, 1, SWINUB, $A5,$FA, 4, BERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 4, 0, LAPRAS, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 4, 1, OMANYTE, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 13, 1, SWINUB, $A5,$FA, 7, MIRACLEBERRY, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 13, 0, SEEL, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $7F, 10, 0, SUICUNE, $66, $66, 0, NO_ITEM, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "Jasmine@", TRAINERTYPE_DVS | TRAINERTYPE_MOVES
	db $06, 6, 1, CUBONE, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, MAKESHIFT
	db $01, 6, 1, SHELLDER, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, LICK
	db $15, 9, 1, ONIX, $8F,$11, NO_MOVE, NO_MOVE, NO_MOVE, SANDSTORM
	db $14, 9, 1, LARVITAR, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $26, 7, 1, PHANPY, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 8, 1, SKARMORY, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $5F, 10, 1, STEELIX, $8F,$11, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $56, 6, 0, PUPITAR, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $4F, 8, 1, SCIZOR, $85,$8F, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 15, 0, ONIX, $8F,$55, STAMPEDE, SANDSTORM, SLAM, EARTHQUAKE
	db $7F, 10, 0, SANDSLASH, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db $6F, 8, 1, MAREEP, $66, $66, NO_MOVE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
YoungsterGroup:
	...
	db $04, 4, 0, RATTATA, $AA,$AA, 1, CUTE_RIBBON
	...
	db $06, 5, 0, CHARMANDER, 1, CINDERS
	db $2F, 0, 1, PIKACHU, 0, NO_ITEM
	db -1 ; end
