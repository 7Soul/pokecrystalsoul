...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_04, BATTLEANIMFUNC_1B, PAL_BATTLE_OB_GRAY, $01 ; ANIM_OBJ_FOOT
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_07, BATTLEANIMFUNC_09, PAL_BATTLE_OB_GRAY, $01 ; ANIM_OBJ_PUNCH_SIDE_TO_SIDE
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_13, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BLUE, $0a ; ANIM_OBJ_ICE_FLICKER
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_18, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, $08 ; ANIM_OBJ_EXPLOSION
	...
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_38, PAL_BATTLE_OB_GRAY, $0c ; ANIM_OBJ_TOXIC
	...
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_1B, BATTLEANIMFUNC_36b, PAL_BATTLE_OB_BROWN, $09 ; ANIM_OBJ_STRENGTH
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_36, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, $05 ; ANIM_OBJ_SHOCKS_AROUND_CENTER
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_40, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_CUT_UP
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_41, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_CUT_LONG_LEFT
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_42, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_CUT_LONG_RIGHT
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, $12 ; ANIM_OBJ_RADIAL_CIRCLES
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_44, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GREEN, $12 ; ANIM_OBJ_CIRCLE
	battleanimobj RELATIVE_X | X_FLIP, $b8, BATTLEANIMFRAMESET_45, BATTLEANIMFUNC_19, PAL_BATTLE_OB_GRAY, $13 ; ANIM_OBJ_GUST
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_46, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $14 ; ANIM_OBJ_AIR_BLADE1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_47, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $14 ; ANIM_OBJ_AIR_BLADE2
	...
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_4A, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, $14 ; ANIM_OBJ_SONICBOOM_JP
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_4B, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, $11 ; ANIM_OBJ_TELEPORT
	...
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $88, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_09, PAL_BATTLE_OB_YELLOW, $10 ; ANIM_OBJ_BEAM_IMPACT
	...
	battleanimobj RELATIVE_X | X_FLIP, $a8, BATTLEANIMFRAMESET_68, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BROWN, $1a ; ANIM_OBJ_DIG
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_69, BATTLEANIMFUNC_01, PAL_BATTLE_OB_GRAY, $1a ; ANIM_OBJ_SAND_ATTACK
	...
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_72, BATTLEANIMFUNC_2C, PAL_BATTLE_OB_GRAY, $1d ; ANIM_OBJ_PIN_MISSILE
	...
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_77, BATTLEANIMFUNC_30, PAL_BATTLE_OB_BROWN, $1f ; ANIM_OBJ_FEATHERGALE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, $1f ; ANIM_OBJ_BONE_CLUB
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $1f ; ANIM_OBJ_BONE_RUSH
	...
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_21, BATTLEANIMFUNC_2F, PAL_BATTLE_OB_BLUE, $0d ; ANIM_OBJ_LEECH_BLUE
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_87, BATTLEANIMFUNC_39, PAL_BATTLE_OB_GRAY, $1f ; ANIM_OBJ_METRONOME
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_30, BATTLEANIMFUNC_3A, PAL_BATTLE_OB_YELLOW, $11 ; ANIM_OBJ_METRONOME_SPARKS
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_AF, BATTLEANIMFUNC_01, PAL_BATTLE_OB_YELLOW, $11 ; ANIM_OBJ_MIRROR_COAT
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_A3
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_A4
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLEANIMFRAMESET_88, BATTLEANIMFUNC_3B, PAL_BATTLE_OB_GREEN, $13 ; ANIM_OBJ_ZOOM_FLIGHT
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_0C, PAL_BATTLE_OB_GRAY, $0d ; ANIM_OBJ_GUNK_SHOT
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_3C, PAL_BATTLE_OB_BLUE, $03 ; ANIM_OBJ_WILL_O_WISP
	battleanimobj RELATIVE_X | X_FLIP, $00, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_4A, PAL_BATTLE_OB_GREEN, $04 ; ANIM_OBJ_LEAF_STORM
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2C, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BLUE, $10 ; ANIM_OBJ_POWER_GEM_BEAM
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_09, PAL_BATTLE_OB_BLUE, $10 ; ANIM_OBJ_POWER_GEM_BEAM_TIP
	...
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, $12 ; ANIM_OBJ_LEAF_SHIELD
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_12, BATTLEANIMFUNC_4D, PAL_BATTLE_OB_BLUE, $09 ; ANIM_OBJ_ICE_SHARD
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_01, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BLUE, $01 ; ANIM_OBJ_HIT_BLUE
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_30, PAL_BATTLE_OB_GRAY, $1f ; ANIM_OBJ_BONEMERANG
	battleanimobj RELATIVE_X, $b8, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_4D, PAL_BATTLE_OB_GRAY, $09 ; ANIM_OBJ_ACCELEROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_00, PAL_BATTLE_OB_BLUE, $01 ; ANIM_OBJ_SPLASH
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_BE, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BROWN, $02 ; ANIM_OBJ_WOOD
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_BF, BATTLEANIMFUNC_3B, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_SNOW
	battleanimobj RELATIVE_X | X_FLIP, $68, BATTLEANIMFRAMESET_56B, BATTLEANIMFUNC_3F, PAL_BATTLE_OB_GREEN, $06 ; ANIM_OBJ_SEED_BOMB
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_C0, BATTLEANIMFUNC_41, PAL_BATTLE_OB_GRAY, $1f ; ANIM_OBJ_ACUPRESSURE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_C1, BATTLEANIMFUNC_4F, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_FEATHER
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_03, PAL_BATTLE_OB_BROWN, $0c ; ANIM_OBJ_MUD
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_67, BATTLEANIMFUNC_26, PAL_BATTLE_OB_BROWN, $1a ; ANIM_OBJ_SAND_SIMPLE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_67B, BATTLEANIMFUNC_26B, PAL_BATTLE_OB_BROWN, $1a ; ANIM_OBJ_SAND_SIMPLE_FLIP
	battleanimobj RELATIVE_X | X_FLIP, $b8, BATTLEANIMFRAMESET_45, BATTLEANIMFUNC_4F, PAL_BATTLE_OB_GRAY, $13 ; ANIM_OBJ_HURRICANE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $88, BATTLEANIMFRAMESET_C2, BATTLEANIMFUNC_09, PAL_BATTLE_OB_YELLOW, $10 ; ANIM_OBJ_BEAM_IMPACT_FLIP
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $ff, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_09, PAL_BATTLE_OB_YELLOW, $10 ; ANIM_OBJ_BEAM_IMPACT_YFIX
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $ff, BATTLEANIMFRAMESET_C2, BATTLEANIMFUNC_09, PAL_BATTLE_OB_YELLOW, $10 ; ANIM_OBJ_BEAM_IMPACT_FLIP_YFIX
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_A8, BATTLEANIMFUNC_04, PAL_BATTLE_OB_YELLOW, $05 ; ANIM_OBJ_ZAP_CANNON2
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_36, BATTLEANIMFUNC_04, PAL_BATTLE_OB_YELLOW, $05 ; ANIM_OBJ_SHOCKS_AROUND_CENTER2
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_5D, BATTLEANIMFUNC_22, PAL_BATTLE_OB_BLUE, $11 ; ANIM_OBJ_AURA_SPHERE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_AF, BATTLEANIMFUNC_01, PAL_BATTLE_OB_BLUE, $11 ; ANIM_OBJ_MIRROR_COAT2
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_30, BATTLEANIMFUNC_33b, PAL_BATTLE_OB_YELLOW, $12 ; ANIM_OBJ_COSMIC_POWER
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_07, PAL_BATTLE_OB_GRAY, $09 ; ANIM_OBJ_BIG_ICE_ROCK
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_07, PAL_BATTLE_OB_BLUE, $09 ; ANIM_OBJ_SMALL_ICE_ROCK
