...
; entries correspond to ANIM_OBJ_* constants
	...
	;battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_A6_2, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_A3
	;battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_A7_2, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_A4
