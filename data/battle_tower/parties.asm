...
BattleTowerMons1:
	...
	db ESPEON
	db LEFTOVERS
	db MUD_BOMB, PSYCHIC_M, PSYCH_UP, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, FROZEN_TAIL, PSYCH_UP, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db GIRAFARIG
	db KINGS_ROCK
	db PSYBEAM, MUD_BOMB, SHADOW_BALL, AGILITY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db TOXIC, GIGA_DRAIN, BITE, CONFUSION
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons2:
	...
	db UMBREON
	db LEFTOVERS
	db PROTECT, TOXIC, MUD_BOMB, ATTRACT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, X_SCISSOR, THUNDERBOLT, FIRE_BLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STEELIX
	db GOLD_BERRY
	db ROAR, FROZEN_TAIL, SWAGGER, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE
	db BRIGHTPOWDER
	db FLAMETHROWER, ROAR, HYPER_BEAM, FROZEN_TAIL
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 35000
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, X_SCISSOR
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PIKACHU
	db LIGHT_BALL
	db THUNDERBOLT, THUNDER_WAVE, SLAM, TOXIC
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SCIZOR
	db FOCUS_BAND
	db ICICLE_WING, SLASH, TOXIC, SANDSTORM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons3:
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, THUNDER_WAVE, ROAR, MUD_BOMB
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, HORN_DRILL, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, SLUDGE_BOMB, SLASH, MUD_BOMB
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, HYPER_BEAM, DIG, NO_MOVE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db GENGAR
	db GOLD_BERRY
	db BITE, LICK, NIGHT_SHADE, GIGA_DRAIN
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons4:
	...
	db TAUROS
	db GOLD_BERRY
	db HYPER_BEAM, EARTHQUAKE, FROZEN_TAIL, NO_MOVE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KINGDRA
	db LEFTOVERS
	db SURF, X_SCISSOR, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STEELIX
	db GOLD_BERRY
	db SANDSTORM, FROZEN_TAIL, EARTHQUAKE, TOXIC
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SCIZOR
	db SCOPE_LENS
	db SLASH, ICICLE_WING, PURSUIT, HYPER_BEAM
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, HYPER_BEAM, SLUDGE_BOMB, MUD_BOMB
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PORYGON2
	db NO_ITEM
	db CONVERSION2, CONVERSION, PSYBEAM, BITE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, X_SCISSOR, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons5:
	...
	db KINGDRA
	db GOLD_BERRY
	db SURF, HYPER_BEAM, BLIZZARD, X_SCISSOR
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SCIZOR
	db LEFTOVERS
	db HYPER_BEAM, SLASH, AGILITY, FROZEN_CLAW
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db AERODACTYL
	db KINGS_ROCK
	db HYPER_BEAM, EARTHQUAKE, FIRE_BLAST, FROZEN_TAIL
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SKARMORY
	db GOLD_BERRY
	db SANDSTORM, FLY, ICICLE_WING, TOXIC
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db STEELIX
	db MIRACLEBERRY
	db SANDSTORM, FROZEN_TAIL, REST, EARTHQUAKE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
...
BattleTowerMons6:
	...
	db KINGDRA
	db LEFTOVERS
	db X_SCISSOR, SURF, HYPER_BEAM, BLIZZARD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db UMBREON
	db GOLD_BERRY
	db MUD_BOMB, MOONLIGHT, PSYCHIC_M, FAINT_ATTACK
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE
	db CHARCOAL
	db FLAMETHROWER, CRUNCH, EXTREMESPEED, FROZEN_TAIL
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SKARMORY
	db MIRACLEBERRY
	db ICICLE_WING, FLY, TOXIC, PROTECT
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db RHYDON
	db QUICK_CLAW
	db EARTHQUAKE, SURF, FROZEN_TAIL, ROCK_SLIDE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db BRIGHTPOWDER
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, LEAF_SHIELD
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons7:
	...
	db VAPOREON
	db LEFTOVERS
	db BLIZZARD, SHADOW_BALL, SURF, MUD_BOMB
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db QUAGSIRE
	db MIRACLEBERRY
	db EARTHQUAKE, SURF, SLUDGE_BOMB, FROZEN_TAIL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLASTOISE
	db QUICK_CLAW
	db HYDRO_PUMP, ICE_PUNCH, HYPER_BEAM, FROZEN_TAIL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons8:
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDER_WAVE, THUNDERBOLT, FROZEN_TAIL, ROAR
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db TAUROS
	db GOLD_BERRY
	db EARTHQUAKE, BODY_SLAM, FROZEN_TAIL, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GENGAR
	db NO_ITEM
	db THUNDERBOLT, SHADOW_BALL, CONFUSE_RAY, BITE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KINGDRA
	db MINT_BERRY
	db REST, SURF, BLIZZARD, X_SCISSOR
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db DRAGONITE
	db GOLD_BERRY
	db THUNDER_WAVE, SURF, THUNDERBOLT, THRASH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SKARMORY
	db QUICK_CLAW
	db ICICLE_WING, FLY, MUD_BOMB, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MOLTRES
	db CHARCOAL
	db FLAMETHROWER, SKY_ATTACK, ICICLE_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db SCOPE_LENS
	db SLASH, EARTHQUAKE, BITE, MUD_BOMB
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons9:
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, MUD_BOMB, MOONLIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db DRAGONITE
	db QUICK_CLAW
	db FIRE_BLAST, HYPER_BEAM, THRASH, BLIZZARD
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 65000
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, ICICLE_WING, TOXIC, NO_MOVE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db JOLTEON
	db BRIGHTPOWDER
	db THUNDERBOLT, ROAR, THUNDER_WAVE, FROZEN_TAIL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db TAUROS
	db KINGS_ROCK
	db HYPER_BEAM, EARTHQUAKE, FROZEN_TAIL, THUNDERBOLT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE
	db LEFTOVERS
	db FLAMETHROWER, EXTREMESPEED, FROZEN_TAIL, HYPER_BEAM
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db FEAROW
	db KINGS_ROCK
	db DRILL_PECK, ICICLE_WING, HYPER_BEAM, MUD_BOMB
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SCIZOR
	db QUICK_CLAW
	db ICICLE_WING, HYPER_BEAM, SLASH, TOXIC
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
