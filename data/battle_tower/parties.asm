...
BattleTowerMons3:
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, SLASH, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db TAUROS
	db GOLD_BERRY
	db HYPER_BEAM, EARTHQUAKE, IRON_TAIL, NO_MOVE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons8:
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, FLY, MUD_BOMB, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons9:
	...
	db SKARMORY
	db QUICK_CLAW
	db SANDSTORM, STEEL_WING, TOXIC, NO_MOVE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db FEAROW
	db KINGS_ROCK
	db DRILL_PECK, STEEL_WING, HYPER_BEAM, MUD_BOMB
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
