...
DoubleSlapVariables:
	...
	db ROCK_BLAST, GEODUDE, GRAVELER, GOLEM, RHYHORN, RHYDON, SHELLDER, CLOYSTER, OMANYTE, OMASTAR, SHUCKLE, -1
	db -2
...
QuickAttackVariables:
	db ICE_SHARD, SEEL, DEWGONG, LAPRAS, SNEASEL, -1
...
DarkPulseVariables:
	db WATERFALL, SEEL, DEWGONG, GOLDEEN, SEAKING, HORSEA, SEADRA, VAPOREON, KINGDRA -1
	db -2
