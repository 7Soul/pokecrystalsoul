...
; entries correspond to constants/move_constants.asm
	...
	move GNAW,         EFFECT_LEECH_HIT,          35, BUG,      PHYSICAL + CONTACT, 100, STA_HALF,  0
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,    SPECIAL,             80, STA_BAR * 3,   0
	...
	move U_TURN,       EFFECT_SWITCH_HIT,         70, BUG,    PHYSICAL + CONTACT,  100, STA_BAR * 2,   0
	...
	move HEAL_BELL,    EFFECT_HEAL_BELL,           0, NORMAL,   STATUS,             100, STA_BAR * 2 + 1,  0
...
VarMoves::
	...
	move MACH_PUNCH,         EFFECT_ALWAYS_HIT,         70, STEEL,    PHYSICAL,           100, STA_BAR + 1, 0 ; SMART_STRIKE
	...
	move BITE,   EFFECT_PRIORITY_HIT,       40, STEEL,    PHYSICAL + CONTACT, 100, STA_BAR,   0 ; BULLET_PUNCH
	...
	move SLASH,        EFFECT_NORMAL_HIT,         90, WATER,    PHYSICAL + CONTACT,  85, STA_BAR * 2,   0 ; CRABHAMMER
	move SLASH,        EFFECT_NORMAL_HIT,         50, FIGHTING, PHYSICAL + CONTACT, 100, STA_BAR,   0 ; KARATE_CHOP
	...
	move DARK_PULSE,   EFFECT_FLINCH_HIT,         80, WATER,    PHYSICAL,           100, STA_BAR * 3,  20 ; WATERFALL
	...
	move EMBER,        EFFECT_NORMAL_HIT,         65, WATER,    SPECIAL,            100, STA_BAR + 1,  10 ; BRINE
	move CHARGE_BEAM,  EFFECT_TOXIC_HIT,          50, POISON,   PHYSICAL + CONTACT, 100, STA_BAR + 1,  50 ; POISON_FANG
