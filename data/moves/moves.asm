...
; entries correspond to constants/move_constants.asm
	...
	move FLY,          EFFECT_FLY,                70, FLYING,   PHYSICAL,  85, 15,   0
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,         110, FIGHTING, PHYSICAL,  90, 15,   0
	...
	move POISON_STING, EFFECT_POISON_HIT,         15, BUG,      PHYSICAL, 100, 35,  30
	...
	move BITE,         EFFECT_FLINCH_HIT,         60, DARK,     PHYSICAL, 100, 10,  30
	...
	move TOXIC,        EFFECT_TOXIC,               0, DARK,     STATUS,    85, 10,   0
	...
	move VENOSHOCK,    EFFECT_VENOSHOCK,          65, DARK,     SPECIAL,  100, 10,   0
	...
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,   PHYSICAL,  90, 15,   0
	move SLASH,        EFFECT_NORMAL_HIT,         70, NORMAL,   PHYSICAL, 100, 20,   0
	move SUBSTITUTE,   EFFECT_SUBSTITUTE,          0, NORMAL,   STATUS,   100, 10,   0
	move STRUGGLE,     EFFECT_NORMAL_HIT,         40, NORMAL,   PHYSICAL, 100,  1,   0
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, DARK,     SPECIAL,  100, 10,  30
	...
	move WAKEUP_SLAP,  EFFECT_WAKEUP_SLAP,        60, FIGHTING, PHYSICAL, 100, 10,   0
	...
	move ICICLE_WING,  EFFECT_DEFENSE_UP_HIT,     70, ICE,      PHYSICAL,  90, 25,  10
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,        70, FIGHTING, PHYSICAL,  85, 10, 100
	move MEGAHORN,     EFFECT_NORMAL_HIT,        100, BUG,      PHYSICAL,  85, 10,   0
	move ZOOM_FLIGHT,  EFFECT_CONFUSE_HIT,        60, BUG,      PHYSICAL, 100, 20,  30
	...
	move FELL_STINGER, EFFECT_FELL_STINGER,       50, BUG,      PHYSICAL, 100, 25,   0
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,  100, ICE,      PHYSICAL,  75, 15,  30
	move FROZEN_CLAW,  EFFECT_ATTACK_UP_HIT,      50, ICE,      PHYSICAL,  95, 35,  10
	...
	move CRUNCH,       EFFECT_SP_DEF_DOWN_HIT,    80, DARK,     PHYSICAL, 100, 20,  20
...
VarMoves::
	...
	move FIRE_PLAY,    EFFECT_FIRE_PLAY,          50, FLYING,   PHYSICAL, 100, 10,   0 ; FLUTTER_CLAP
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, ROCK,     PHYSICAL,  80,  5,   0 ; STONE_EDGE
	move DOUBLE_EDGE,  EFFECT_RECOIL_HIT,        120, FLYING,   PHYSICAL, 100, 15,   0 ; BRAVE_BIRD
	move DOUBLE_EDGE,  EFFECT_RECOIL_HIT,        120, GRASS,    PHYSICAL, 100, 15,   0 ; WOOD_HAMMER
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, ICE,      PHYSICAL, 100, 30,   0 ; ICE_SHARD
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, ROCK,     PHYSICAL, 100, 20,   0 ; ACCELEROCK
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, WATER,    SPECIAL,  100, 20,   0 ; AQUA_JET
	move SLASH,        EFFECT_NORMAL_HIT,         70, DARK,     PHYSICAL, 100, 15,   0 ; NIGHT_SLASH
	move SLASH,        EFFECT_NORMAL_HIT,         90, GRASS,    PHYSICAL, 100, 15,   0 ; LEAF_BLADE
	move DRILL_PECK,   EFFECT_NORMAL_HIT,         80, GRASS,    PHYSICAL, 100, 20,   0 ; SEED_BOMB
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT,         60, FLYING,   PHYSICAL, 100, 20,   0 ; AERIAL_ACE
	...
	move HORN_DRILL,   EFFECT_OHKO,                1, DARK,     PHYSICAL,  30,  5,   0 ; GUILLOTINE
	...
	move REVERSAL,     EFFECT_REVERSAL,            1, NORMAL,   PHYSICAL, 100, 15,   0 ; FLAIL
	...
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   75, WATER,    PHYSICAL,  95, 10,  50 ; RAZOR_SHELL
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING, PHYSICAL, 100, 15,  30 ; SPIRAL_KICK
	...
	move LICK,        EFFECT_PARALYZE_HIT,        70, ELECTRIC, PHYSICAL, 100, 10,  30 ; SHOCK_STING
	...
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         35, NORMAL,   PHYSICAL, 100, 15,   0 ; DOUBLE_HIT
