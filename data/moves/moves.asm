...
; entries correspond to constants/move_constants.asm
	...
	move UNUSED_MOVE_1,  EFFECT_NORMAL_HIT,       50, FIGHTING, PHYSICAL + CONTACT, 100, STA_BAR,   0
	...
	move UNUSED_MOVE_3, EFFECT_NORMAL_HIT,        90, WATER,    PHYSICAL + CONTACT,  85, STA_BAR * 2,   0
