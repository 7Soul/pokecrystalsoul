...
VarMoves::
	...
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   95, WATER,    PHYSICAL,  75, 10,  50 ; RAZOR_SHELL
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING, PHYSICAL,  100, 15, 30 ; SPIRAL_KICK
	move CONSTRICT,    EFFECT_NORMAL_HIT,        120, GRASS,    PHYSICAL,   5, 10,   0 ; POWER_WHIP
	move AGILITY,      EFFECT_SPEED_UP_2,          0, ROCK,     STATUS,   100, 20,   0 ; ROCK_POLISH
	move SPARK,        EFFECT_PARALYZE_HIT,       70, ELECTRIC, PHYSICAL, 100, 10,  30 ; SHOCK_STING
