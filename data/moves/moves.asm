...
; entries correspond to constants/move_constants.asm
	...
	move ICICLE_WING,  EFFECT_DEFENSE_UP_HIT,     70, ICE,      PHYSICAL + CONTACT,  90, STA_BAR * 2,  10
	...
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,  100, ICE,      PHYSICAL + CONTACT,  75, STA_BAR * 2 + 1,  30
	move FROZEN_CLAW,  EFFECT_ATTACK_UP_HIT,      50, ICE,      PHYSICAL + CONTACT,  95, STA_BAR + 1,  10
...
VarMoves::
	...
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, ROCK,     STATUS,             100, STA_HALF,  0 ; IRON_DEFENSE
	...
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   75, WATER,    PHYSICAL + CONTACT,  95, STA_BAR + 1,  50 ; RAZOR_SHELL
	move FROZEN_TAIL,  EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING, PHYSICAL + CONTACT, 100, STA_BAR + 1,  30 ; SPIRAL_KICK
