	...
	; tm/hm learnset
	tmhm CURSE, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, SOLARBEAM, PRISM_LIGHT, THUNDER, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, SWAGGER, SWIFT, DEFENSE_CURL, DREAM_EATER, BRICK_BREAK, POWER_GEM, ATTRACT, FIRE_FLICK, NIGHTMARE, WILD_STORM, PSYWAVE, MAGICAL_LEAF, HYPER_SONAR, THUNDERBOLT, ICE_BEAM, REST, SNORE, SLEEP_TALK
	; end
