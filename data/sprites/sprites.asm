...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite CooltrainerFSpriteGFX, 12, WALKING_SPRITE, PAL_OW_PINK
	...
	overworld_sprite ArinSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite DannySpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
