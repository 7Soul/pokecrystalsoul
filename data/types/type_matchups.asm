TypeMatchups:
	...
	db GRASS,     GRASS,     NOT_VERY_EFFECTIVE ; GRASS
	...
	db DARK,      ELECTRIC,  SUPER_EFFECTIVE
	...
	db POISON,    POISON,    NOT_VERY_EFFECTIVE ; POISON
