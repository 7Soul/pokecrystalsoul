TraitNames::
	...
	db "Revitalize@"       ; TRAIT_SPEED_TRANSFORM
	...
	db "Cheer Up@"         ; TRAIT_ALL_STATS_BOTH_SIDES
	...
	db "Headache@"         ; TRAIT_RANDOM_STAT_AFTER_4_TURNS
	...
	db "Second Skin@"      ; TRAIT_REDUCE_PSN_AND_POISON
	db "Protected Fur@"    ; TRAIT_REDUCE_BRN_AND_FIRE
	db "Ground Wire@"      ; TRAIT_REDUCE_PRZ_AND_ELECTRIC
	db "Super Carapace@"   ; TRAIT_REDUCE_FLINCH_AND_ROCK
	...
	db "Maleable@"         ; TRAIT_REDUCE_ROCK_GROUND_HIT
	db "Hit Blocker@"      ; TRAIT_REDUCE_FIGHTING_ICE_HIT
	db "Cleanse@"          ; TRAIT_REDUCE_POISON_PSYCHIC_HIT
