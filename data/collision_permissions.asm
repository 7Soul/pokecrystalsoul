...
; entries correspond to COLL_* constants
	...
	NONTALKABLE LANDTILE  ; COLL_SHALLOW_WATER
	...
	NONTALKABLE  WALLTILE ; COLL_PC_SIGN
	...
	NONTALKABLE  WALLTILE ; COLL_PC_VENDING
