	...
	tilecoll FLOOR, FLOOR, FLOOR, HOP_RIGHT ; 28
	tilecoll FLOOR, FLOOR, HOP_LEFT, FLOOR ; 29
	...
	tilecoll WALL, WALL, FLOOR, HOP_RIGHT ; 4c
	tilecoll FLOOR, FLOOR, WALL, HOP_DOWN ; 4d
