...
ENDM
	...
	connection east, OlivineCity, OLIVINE_CITY, -11
	...
	map_attributes Route39OlivineGate, ROUTE_39_OLIVINE_GATE, $00, 0
	...
	map_attributes Route28SteelWingHouse, ROUTE_28_ICICLE_WING_HOUSE, $00, 0
